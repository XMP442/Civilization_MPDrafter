...
# Initialize Intents, for easier expansion.
...
@option("playercount", description="How many players?", min_value=1, max_value=12, type=int, required=True)
@option("bancount", description="How many bans per player?", min_value=1, max_value=4, default=2, type=int, required=False)
@option("pickcount", description="How many picks per player?", min_value=1, max_value=6, default=3, type=int, required=False)
...
@lobby.command(name="banc", description="Ban a Civilization.")
